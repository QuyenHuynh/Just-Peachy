...
const activities = [
	...
	{
		_id: 10,
		activity: 'Wanna Watch the Muppets?',
	...
	{
		_id: 15,
		activity: 'Support Your Local Broke Artists',
	...
	{
		_id: 21,
		activity: 'Where the Real Business Happens',
	...
	{
		_id: 27,
		activity: "Punk Rock is Not Dead",
...
function getWeather() {
	...
	$.ajax({
		...
		$(".city").html("<img id='raindrop' src='../images/raindrop2.png'> Today's Weather in " + response.name + ":");
...
var address = randomizedActivity.address;
...
$("#next-btn").on("click", function () {
	...
	address = randomizedActivity.address;
	...
	$("#activity_address").html("<address>" + address + "</address>");
});
...
$("#activity_address").append("<address>" + address + "</address>");